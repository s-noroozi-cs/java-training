...
public class Example2 {
    ...
    public static void main(String[] args) {
        ...
        Optional<Float> min = productsList.stream()
                .map(Product::price)
                .collect(Collectors.minBy(Float::compareTo));
